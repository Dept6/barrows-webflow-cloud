...
import _styles from "./RetailPartnerCard.module.css";
...
export function RetailPartnerCard({
  as: _Component = _Builtin.Block,
  before = "https://cdn.prod.website-files.com/6850126bae0232269c4a1dcc/6850126bae0232269c4a1e08_Tesco%202_After.avif",
  product = "Power Aisle",
  after = "https://cdn.prod.website-files.com/6850126bae0232269c4a1dcc/6850126bae0232269c4a1e19_Tesco%202_Before.avif",
  ...
  return (
    <_Component
      className={_utils.cx(_styles, "retail-card-2", "is-retailer")}
      tag="div"
      data-reveal-blur="true"
    >
      <_Builtin.Block
        className={_utils.cx(_styles, "image-card01-2")}
        tag="div"
      >
        <_Builtin.Image
        ...
        <_Builtin.Image
          ...
          data-w-id="2270821b-a3f9-7fb4-e05f-cf5eb13710d8"
          width="auto"
          height="auto"
          loading="lazy"
      ...
      <_Builtin.Block className={_utils.cx(_styles, "div-block-20")} tag="div">
        <_Builtin.Image
        ...
        />
        <_Builtin.Block
          className={_utils.cx(_styles, "sub04-small-line-2")}
          tag="div"
        >
          {product}
        </_Builtin.Block>
